...
#define TSK_STACK_CANARY 1608 /* offsetof(struct task_struct, stack_canary) */

#define THREAD_CPU_CONTEXT 3456 /* offsetof(struct task_struct, thread.cpu_context) */
#define THREAD_SCTLR_USER 5104 /* offsetof(struct task_struct, thread.sctlr_user) */
#define THREAD_KEYS_USER 5000 /* offsetof(struct task_struct, thread.keys_user) */
#define THREAD_KEYS_KERNEL 5080 /* offsetof(struct task_struct, thread.keys_kernel) */
#define THREAD_MTE_CTRL 5096 /* offsetof(struct task_struct, thread.mte_ctrl) */
...
#define MM_CONTEXT_ID 984 /* offsetof(struct mm_struct, context.id.counter) */
...
#define VCPU_FAULT_DISR 3432 /* offsetof(struct kvm_vcpu, arch.fault.disr_el1) */
#define VCPU_HCR_EL2 3384 /* offsetof(struct kvm_vcpu, arch.hcr_el2) */
...
#define NVHE_INIT_TMP 80 /* offsetof(struct kvm_nvhe_init_params, tmp) */
...
#define FTRACE_OPS_DIRECT_CALL 240 /* offsetof(struct ftrace_ops, direct_call) */
